...
测试：./main -m ../assets/random-32-32-10.map -i ../assets/random-32-32-10-random-1.scen -N 10 -v 1 -o ../tests/result_test.txt --objective 1
测试：mapf-visualizer ../../mapf-visualizer/assets/random-32-32-20.map ../tests/result_test.txt
